...
def parse_args():
    ...
    parser.add_argument('--spout_size', nargs = 2, type=int, default=[512, 512], help='Width and height of the spout receiver and sender')   
    ...
    parser.add_argument('--silent', type=bool, default=True, help='Hide pygame window')
